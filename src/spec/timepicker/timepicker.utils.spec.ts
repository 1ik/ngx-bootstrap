import {
  changeTime, createDate,
  isNumber,
  isValidDate, padNumber,
  parseHours, parseMinutes, parseSeconds, parseTime, setTime,
  toNumber
...
describe('Utils: Timepicker', () => {
  ...
  it('should change time invalid value', () => {
    // unreachable code
  });
  ...
  it('should set time invalid value', () => {
    // unreachable code
  });
  ...
  it('should create date invalid value', () => {
    // unreachable code
  });
